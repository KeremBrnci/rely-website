...
import type { HeroGlowKey } from "@/config/marketing/hero-glow";
...
export function SolutionHero({
  ...
  return (
    <MarketingSection id="hero" {...solutionMarketingSectionShell.hero}>
      <HeroGlow preset={glow} />
      <Container className="relative z-10 flex flex-col py-[clamp(3.5rem,8vh,6rem)]">
        <div className="max-w-[46rem]">
          ...
          <p className="mt-5 max-w-[40rem] text-pretty text-[15px] leading-[1.7] tracking-[-0.01em] text-[color:var(--marketing-body-muted)] md:text-base">
            <MarketingRichText text={hero.subtitle} />
          </p>
