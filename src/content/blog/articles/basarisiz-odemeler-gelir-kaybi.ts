...
export const articleBody = {
  sections: [
    ...
    {
      type: "p",
      text: "Token’lı tekrarlayan tahsilat Craftgate veya İyzico üzerinden; kartlar RELY’de değil, ödeme kuruluşunda saklanır. Dunning kuralları, e-posta ve SMS bildirimleri ve müşteri storefront’u tek operasyon setinde yönetilir; recovery rate KPI olarak dashboard’da izlenir.",
    },
    {
      type: "h2",
